...
from ZeMusic.utils import get_readable_time
...
@app.on_message(filters.command(["حظر عام", "احظره عام"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["gbannedusers", "المحظورين عام"]) & SUDOERS)
@language
